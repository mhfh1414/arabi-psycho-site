# -*- coding: utf-8 -*-
# cbt.py — صفحة CBT مستقلة

def register_cbt(app, shell, BRAND, LOGO, TG_URL, WA_URL):
    CBT_HTML = r"""
<div class="card">
  <h1>🧠 العلاج المعرفي السلوكي (CBT)</h1>
  <p class="small">اختر خطة/خطة+خطة ثم أنشئ جدول 7/10/14 يوم تلقائيًا. <b>الحفظ تلقائي</b>، ويمكن تنزيل/طباعة/مشاركة.</p>

  <h2>خطط جاهزة (15 خطة)</h2>
  <div class="grid">
    <div class="tile"><h3>BA — تنشيط سلوكي</h3><ol>
      <li>3 نشاطات مجزية يوميًا.</li><li>قياس مزاج قبل/بعد.</li><li>رفع الصعوبة تدريجيًا.</li></ol>
    ...
    <div class="tile"><h3>SH — نظافة النوم</h3><ol>
      <li>مواعيد ثابتة.</li><li>إيقاف الشاشات 60د.</li><li>لا كافيين 6س قبل.</li></ol>
    ...
    <div class="tile"><h3>PTSD — تأريض</h3><ol>
      <li>5-4-3-2-1.</li><li>تنفّس هادئ.</li><li>روتين أمان.</li></ol>
  ...
  <script>
    ...
    (function fill(){
      ...
      let saved={};
      try{
        saved = JSON.parse(localStorage.getItem('cbt_state') || '{}');
      }catch(e){ saved={}; }
