...
v8.0 production / single-file Flask
...
الصفحات:
    ...
    /tests       اختبارات نفسية/شخصية قصيرة (قلق/اكتئاب/ثقة/غضب/إدمان)
    /health      Ping جاهزية السيرفر

⚠ مهم:
- هذا مو تشخيص طبي ولا وصفة علاج.
- لا تبدأ/توقف دواء بدون طبيب/صيدلي مختص.
- إذا عندك أفكار إيذاء أو انتحار: هذا طارئ. لازم دعم فوري وجهًا لوجه.
...
<div class="card" style="margin-bottom:18px;">
  ...
  <div class="small">
    ...
    <br/>2) 🧠 نبني لك خطة CBT يومية (7 / 10 / 14 يوم)
    <br/>3) 📊 لو تبغى قياس سريع: «اختبارات نفسية»
    <br/>4) 💊 تشوف أدوية الطب النفسي؟ قسم «دليل الأدوية»
    <br/>5) 🤝 تحتاج إنسان الآن؟ زر واحد يوصلك باختصاصي.
  </div>
  <div class="note">"نحن نحترمك. ألمك حقيقي. وبدل ما نقول 'شد حيلك' نعطيك خطة."</div>
</div>
...
<div class="grid">
  ...
  <div class="tile">
    ...
    <p class="small">
      قلق؟ اكتئاب؟ غضب؟ اندفاع؟ ثقتك بنفسك؟
      <br/>10 أسئلة وتاخذ درجة فورية + ملاحظات.
    </p>
  ...
  <div class="tile">
    ...
    <p class="small">
      ...
      <br/>ليش يوصفه الدكتور؟ آثار جانبية شائعة؟ متى حالة طبية عاجلة؟
    </p>
...
def case():
    ...
    _notes = request.form.get("notes", "").strip()  # مستقبلاً ممكن نحطها في التقرير
...
# ======================== /tests ========================
# صفحة اختبارات نفسية سريعة داخل المتصفح بدون تخزين سيرفري
# كل اختبار: 10 عبارات / اختيارات 0..3 (أبدًا - أحيانًا - كثير - دائم)
# نحسب المجموع ونفسر.
...
<div class="card">
  ...
  <div class="note">
    مهم:
    <br/>• الأسئلة قصيرة جدًا، الهدف وعي ذاتي مو تشخيص رسمي.
    <br/>• لا تستخدم النتايج بدل دكتور، خصوصًا لو فيه أفكار إيذاء أو انتحار.
  ...
  <script>
    ...
    //
    // تفسير (تقريبي):
    //   منخفض / متوسط / عالي "الضغط" ويحتاج تدخل سلوكي منظم
    //   أو "عالي جدًا" → يُنصح نقاش مباشر مع مختص
    ...
    const TESTS = {
      anxiety:{
        ...
        ranges:[
          ...
          {max:22, text:"قلق مرتفع. تمرين التعرض التدريجي ووقت القلق المحدد مهم."},
          {max:30, text:"قلق عالي جدًا. يفضل جلسة مختص أو دعم مباشر."}
        ]
      },
      depression:{
        ...
        items:[
          ...
          "أحيانا أحس جسمي ثقيل / حركتي بطيئة.",
          "جاتني أفكار إيذاء أو هروب نهائي من الحياة."
        ],
        ranges:[
          {max:7,  text:"مزاجك متأثر بسيط. استمر بنشاطات ممتعة ولو إجبار خفيف."},
          {max:15, text:"انخفاض مزاج متوسط. مهم نرفع السلوك الإيجابي اليومي (BA)."},
          {max:22, text:"مزاج منخفض واضح. راقب الأمان، خطط دعم يومي موحدة."},
          {max:30, text:"أعراض اكتئاب عالية. تواصل مع مختص (ولو كتابيًا) مهم جدًا 🙏"}
        ]
      },
      confidence:{
        ...
        items:[
          "أنتقد نفسي بقسوة.",
          "أخاف أغلط قدام الناس لأن بشعر بالفضيحة.",
          "أقارن نفسي بالغير وأطلع أقل منهم.",
          "صعب أقول 'أنا فخور بنفسي'.",
          "أشعر أني عبء على الناس.",
          "أجيّب إنجاز حلو بس أقول 'عادي أي أحد يقدر'.",
          "أغير رأيي بسرعة لو أحد اعترض، حتى لو أنا مقتنع.",
          "أحس أن الآخرين دايم يشوفون عيوبي.",
          "أعطي الناس أكثر من اللازم عشان ما يزعلون.",
          "أستحي أطلب احتياجي بوضوح ('أبغى / أحتاج')."
        ],
        ranges:[
          {max:7,  text:"ثقتك جيدة إجمالًا، استمر 👏"},
          {max:15, text:"ثقتك تهتز أحيانًا. جرّب خطة SC (تعزيز الثقة)."},
          {max:22, text:"صورة الذات ضعيفة. مهم تدريب الحزم (SS) وتسجيل النجاحات."},
          {max:30, text:"جلد ذات عالي. يفضل جلسة دعم حقيقية (أخصائي نفسي)."}
        ]
      },
      anger:{
        title:"غضب / اندفاع / تحكم بالانفجار",
        items:[
          "أنفجر بسرعة (صياح/سلوك اندفاعي).",
          "أندم بعدها وأحس بخزي.",
          "أضرب شيء / أرمي شيء لما أتعصب.",
          "أهدد أو أجرح بالكلام وقت الغضب.",
          "أحس جسمي يشتعل وقت المشكلة.",
          "ما أعرف أوقف اللحظة قبل ما أنفجر.",
          "أغار جداً أو أشك بسرعة.",
          "أقول أشياء جارحة بس عشان أوجع.",
          "أحس الناس يستفزوني بدون احترام.",
          "صعب أرجع أهدى بسرعة بعد ما أتعصب."
        ],
        ranges:[
          {max:7,  text:"اندفاعك تحت السيطرة غالبًا 👍"},
          {max:15, text:"في توتر. جرّب خطة AM (إدارة الغضب) ووقت تهدئة."},
          {max:22, text:"الغضب مأثر على العلاقة/البيت. لازم تدريب إيقاف مؤقت."},
          {max:30, text:"اندفاع عالي جدًا. يفضل تدخل علاجي مباشر عشان الأمان."}
        ]
      },
      addiction:{
        title:"اشتهاء / سلوك إدماني",
        items:[
          "أفكر بالمادة/السلوك بشكل متكرر طول اليوم.",
          "أحس أني أحتاجها الآن عشان أهدى.",
          "أستخدم حتى لو أعرف أنه يدمّرني.",
          "صار عندي مشاكل أسرية/عملية بسبب هالشي.",
          "أحس إني ما أقدر أوقف حتى لو حاولت.",
          "رجعت بعد فترة انقطاع (انتكاسة).",
          "لو ما حصلتها جسمي أو مزاجي ينهار.",
          "أصرف وقت/فلوس كثيرة عشانها.",
          "أكذب أو أخبي عشان أستمر.",
          "أقول 'آخر مرة' بس ما تكون آخر مرة."
        ],
        ranges:[
          {max:7,  text:"حاليًا التحكم معقول. خلك واعي للمحفزات 👀"},
          {max:15, text:"خطر متوسط. نبغى خطة RP (منع الانتكاس) ودعم صادق بدون حكم."},
          {max:22, text:"علامات اعتماد واضحة. لازم شبكة دعم آمنة فورًا."},
          {max:30, text:"سلوك إدماني عالي. اطلب مساعدة بشرية الآن، لا تنتظر 🙏"}
        ]
      }
    };
    ...
    function renderQuiz(){
      ...
      if(!test){ box.innerHTML = "<div class='small'>ما لقيت الاختبار.</div>"; return; }
      ...
      test.items.forEach(function(q, idx){
        ...
        html += `
          <li style="margin-bottom:10px">
            ${q}<br/>
            <select data-q="${n}" style="margin-top:6px;max-width:220px;">
              <option value="0">0 — أبدًا / نادر</option>
              <option value="1">1 — أحيانًا</option>
              <option value="2">2 — كثير</option>
              <option value="3">3 — دائم / تقريبًا كل يوم</option>
            </select>
          </li>
        `;
      });
      ...
      html += `
        <div class="row" style="margin-top:14px">
          <button class="btn gold" onclick="calcScore()">عرض النتيجة</button>
          <button class="btn alt" onclick="window.print()">🖨️ طباعة</button>
        </div>
      `;
...
<div class="card">
  ...
  <div class="note">
    مهم:
    <br/>• الهدف وعي ذاتي وليس تشخيصًا طبيًا.
    <br/>• لا تستخدم النتيجة كبديل عن مختص نفسي.
    <br/>• الإجابات لا تُحفظ على السيرفر، بل تعمل محليًا فقط.
  </div>
  ...
  <script>
    const TESTS = {
      anxiety:{
        ...
        items:[
          ...
          "عضلاتي مشدودة / جسمي متوتر.",
          "صعوبة نوم بسبب القلق.",
          "قلبي يدق بسرعة أو رجفة وقت التوتر.",
          "أتوتر من مواقف بسيطة أكثر من اللازم.",
          "أحتاج أطمن نفسي كثير.",
          "أتهرب من المواقف خوفًا من القلق.",
          "تركيزي يضيع بسبب التفكير الزايد.",
          "أخاف أن يصير شيء سيئ قريبًا."
        ],
        ranges:[
          {max:7,text:"قلق بسيط 👌"},
          {max:15,text:"قلق متوسط — جرّب تمارين التنفس / CBT (وقت القلق)."},
          {max:22,text:"قلق مرتفع — تعرّض تدريجي ووقت محدد للقلق."},
          {max:30,text:"قلق شديد — الأفضل مراجعة مختص نفسي 🙏"}
        ]
      },
      depression:{
        title:"مزاج منخفض / اكتئاب",
        items:[
          "مزاجي حزين أو ثقيل أغلب اليوم.",
          "ما أستمتع بالأشياء مثل قبل.",
          "طاقة جسمي منخفضة جدًا.",
          "نومي متلخبط.",
          "إحساس بالذنب أو عدم القيمة.",
          "صعوبة تركيز.",
          "أفكر أني عديم الفائدة.",
          "تشاؤم من المستقبل.",
          "بطء بالحركة أو التفكير.",
          "أفكار إيذاء أو انتحار."
        ],
        ranges:[
          {max:7,text:"مزاج طبيعي مع بعض الضغط."},
          {max:15,text:"اكتئاب بسيط — نشّط نفسك بخطة (BA)."},
          {max:22,text:"اكتئاب متوسط — جرّب CBT + دعم بشري."},
          {max:30,text:"اكتئاب شديد — تواصل مع مختص فورًا 🙏"}
        ]
      },
      confidence:{
        title:"الثقة بالنفس",
        items:[
          "أنتقد نفسي كثير.",
          "أخاف أغلط قدام الناس.",
          "أقارن نفسي بالناس.",
          "صعب أقول 'أنا فخور بنفسي'.",
          "أشعر أني عبء على الآخرين.",
          "أنجز بس أقلل من قيمته.",
          "أتراجع عن رأيي بسهولة.",
          "أركز على عيوبي أكثر من نجاحي.",
          "أعطي الناس أكثر من اللازم عشان ما يزعلون.",
          "أستحي أطلب احتياجي بوضوح."
        ],
        ranges:[
          {max:7,text:"ثقتك طيبة 👍"},
          {max:15,text:"ثقة متوسطة — جرّب خطة (SC)."},
          {max:22,text:"ثقة ضعيفة — درّب الحزم (SS)."},
          {max:30,text:"ثقة منخفضة جدًا — يفضل جلسة دعم سلوكي."}
        ]
      },
      anger:{
        title:"غضب / اندفاع",
        items:[
          ...
          "أندم بعد الغضب.",
          "أصرخ أو أضرب شيء.",
          "أقول كلام جارح وقت الزعل.",
          "أحس جسمي مشتعل وقت الغضب.",
          "ما أقدر أوقف اللحظة قبل الانفجار.",
          "أغار بشدة أو أشك بسرعة.",
          "أوجّه كلام مؤذي بس لأوجع.",
          "أحس الناس تستفزني.",
          "صعب أهدى بعد المشكلة."
        ],
        ranges:[
          {max:7,text:"غضبك مضبوط 👍"},
          {max:15,text:"اندفاع متوسط — جرّب خطة (AM)."},
          {max:22,text:"غضب متكرر — تدرب على الإيقاف المؤقت والتنفس."},
          {max:30,text:"اندفاع عالي — يفضل تدخل مختص للأمان."}
        ]
      },
      addiction:{
        title:"اشتهاء / سلوك إدماني",
        items:[
          "أفكر بالمادة/السلوك طول اليوم.",
          "أحتاج أستخدم عشان أهدأ.",
          "أستخدم رغم الضرر.",
          "مشاكل بسبب الاستخدام.",
          "ما أقدر أوقف.",
          "انتكاسات متكررة.",
          "أعراض انسحاب.",
          "وقت/مال كثير عليه.",
          "أكذب أو أخبي.",
          "أقول آخر مرة بس أرجع."
        ],
        ranges:[
          {max:7,text:"تحكم جيد 👌"},
          {max:15,text:"خطر متوسط — جرّب خطة (RP)."},
          {max:22,text:"اعتماد واضح — ابحث دعم بشري."},
          {max:30,text:"إدمان شديد — تدخل علاجي ضروري 🙏"}
        ]
      }
    };
    ...
    function renderQuiz(){
      ...
      const test = TESTS[testKey];
      let html = "<h3>"+test.title+"</h3><ol>";
      test.items.forEach((q,i)=>{
        html += `<li>${q}<br><select data-q="${i}"><option value="0">0 أبدًا</option><option value="1">1 أحيانًا</option><option value="2">2 كثير</option><option value="3">3 دائمًا</option></select></li>`;
      });
      html += "</ol><button class='btn gold' onclick='calcScore()'>عرض النتيجة</button>";
      box.innerHTML = html;
    }

    function calcScore(){
      const picker = document.getElementById('testPicker');
      const test = TESTS[picker.value];
      const vals = [...document.querySelectorAll('#quizBox select')].map(s=>parseInt(s.value||'0'));
      const total = vals.reduce((a,b)=>a+b,0);
      let text = "";
      for(const r of test.ranges){ if(total<=r.max){ text=r.text; break; } }
      const resultBox=document.getElementById('resultBox');
      resultBox.style.display='block';
      resultBox.innerHTML = `
        <div style="background:linear-gradient(145deg,#fff8dc,#fff2b2);border:2px solid gold;border-radius:14px;padding:16px;">
          <h3>النتيجة: ${total} / ${vals.length*3}</h3>
          <div class='note' style='font-weight:700;color:#4b0082;'>${text}</div>
          <div style='margin-top:12px;'>
            <button class='btn gold' onclick='window.print()'>🖨️ طباعة النتيجة</button>
            <button class='btn' style='margin-right:6px;' onclick='renderQuiz()'>🔄 إعادة الاختبار</button>
          </div>
        </div>
      `;
    }
...
@app.get("/tests")
def tests():
    return shell("اختبارات نفسية — " + BRAND, TESTS_PAGE_HTML, "tests")
...
def pharm():
    meds = [
        ("سيرترالين","اكتئاب / قلق","غثيان، صداع، ضعف جنسي","لا توقف فجأة"),
        ("فلوكستين","اكتئاب / وسواس","تنشيط بالبداية","يتعارض مع بعض الأدوية"),
        ("كويتيابين","ذهان / قلق / أرق","نعاس، زيادة وزن","تحت إشراف طبي"),
        ("ألبرازولام","هلع / قلق شديد مؤقت","نعاس، اعتماد جسدي","إدماني لا يُستخدم طويل")
    ]
    html = "<div class='card'><h1>💊 الصيدلية النفسية</h1><p class='small'>للتثقيف فقط، لا تبدأ أو توقف دواء بدون طبيب.</p>"
    for n,u,s,w in meds:
        html += f"<div class='tile'><h3>{n}</h3><b>يُستخدم لـ:</b> {u}<br><b>أعراض جانبية:</b> {s}<br><b>تحذير:</b> {w}</div>"
    html += "</div>"
    return shell("الصيدلية النفسية — " + BRAND, html, "pharm")
