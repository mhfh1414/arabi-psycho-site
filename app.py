...
<div class="card" style="border:2px solid #000;">
  ...
  <p class="small">
    لدينا مجموعة من الاختبارات النفسية لمساعدتك على فهم نمطك النفسي بشكل أعمق. هذه الاختبارات لأغراض توعوية فقط وليست تشخيصًا طبيًا.
  </p>
  <div class="note">
    <p>اضغط على "احسب النتيجة" ثم استعرض النتيجة. تم احسبها يدويًا.</p>
  </div>
</div>
"""
...
# 3️⃣ /tests: الراوت الجديد
@app.route("/tests")
def tests_page():
    page_html = r"""
    <div class="card" style="border:2px solid #000;max-width:900px;margin:auto;padding:20px;border-radius:10px;">
        <h1>اختبارات مساعدة ذاتية</h1>
        <p class="small">
            هذه الأدوات تعطيك فكرة عن نمط التفكير أو المشاعر أو السلوك. ليست تشخيصًا طبيًا، لكنها تساعدك على فهم نمطك النفسي أكثر.
            إذا كانت النتيجة عالية جدًا أو فيها خطر على سلامتك، تواصل فورًا مع مختص.
        </p>
        <div class="note">
