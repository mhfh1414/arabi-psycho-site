  ...
  <script>
    ...
    const MEDS = [
      ...
      },
      {
        ...
        klass:"مضاد ذهان غير نمطي",
        uses:"فصام، هوس، نوبات غضب/اندفاع ببعض الاضطرابات السلوكية",
      ...
      },
      {
        ...
        warn:"فيه نسخ طويلة المفعول (حقنة شهرية/ثلاثية) تحت إشراف طبي."
      },
      {
        name:"أريببرازول (Aripiprazole / أبيليفاي)",
        klass:"مضاد ذهان غير نمطي جزئي التأثير",
        uses:"ذهان، هوس، أحيانًا يُضاف للاكتئاب المقاوم",
        sfx:"نشاط/عصبية/أرق عند بعض الناس بدل النعاس",
        warn:"يراقب أي سلوك اندفاعي جديد (صرف فلوس، أكل قهري...)."
      },
      {
        name:"زيبراسيدون (Ziprasidone / جيوودون)",
        klass:"مضاد ذهان غير نمطي",
        uses:"ذهان، هوس",
        sfx:"غثيان، دوار، ممكن إطالة نبض القلب",
        warn:"يُؤخذ غالبًا مع الأكل، ويراقب نظم القلب."
      },
      {
        ...
        warn:"عادة أقل زيادة وزن من بعض الأدوية الثانية بس لازم إشراف."
      },
      {
        ...
        warn:"يحتاج فحوص دم دورية لعدد كريات الدم البيضاء. خط أحمر: بدون طبيب لا يُستخدم."
      },
      {
        ...
        warn:"عادة يستعمل تحت إشراف مباشر/طوارئ."
      },
      ...
      // قلق / مهدئات / نوم / أعصاب
      {
        ...
        sfx:"نعاس قوي، تباطؤ تفكير، تعلق دوائي",
