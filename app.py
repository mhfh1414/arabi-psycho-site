# -*- coding: utf-8 -*-
# app.py — Arabi Psycho (v2.8 One-File Stable)
...
def shell(title: str, content: str, visitors: Optional[int] = None) -> str:
    ...
    # لا نضع f-strings داخل سكربتات؛ كل السكربتات أدناه نص خام بلا أقواس Python.
...
def add_headers(resp):
    # السماح بالـ inline scripts اللازمة للصفحات مع تقييد بقية المصادر
    csp = (
