...
# ======================= قاعدة DSM (موسّعة وقابلة للتكبير) =======================
DSM_DB = {
    # اضطرابات المزاج
    "اضطراب اكتئابي جسيم": [
        ...
        "أرق","قلة نوم","كثرة نوم","اضطراب نوم","فقدان شهية","قلة اكل","فقدان وزن","زيادة وزن",
        "تركيز ضعيف","احتقار الذات","تشاؤم","تفكير سلبي"
    ],
    ...
    "رهاب محدد": ["رهاب","خوف شديد","تجنب مواقف","خوف من طيران","خوف من حشرات","خوف من المرتفعات"],
    ...
    "شخصية نرجسية": ["عظمة","حاجة إعجاب","تعاطف قليل","استغلالي","حساس للنقد"],
    "شخصية معادية للمجتمع": ["خرق قواعد","عدوانية","خداع","اندفاع","لامسؤولية","ندم قليل"],
    "شخصية اجتنابية": ["خجل شديد","تجنب نقد","نقص كفاءة","حساسية رفض"],
    "شخصية اتكالية": ["اتكالية","صعوبة قرار","خوف فراق","احتياج دعم مستمر"],
    "شخصية وسواسية قهرية": ["انشغال بالتفاصيل","كمالية","صرامة","عناد","انشغال بالقواعد"],
    "شخصية انسحابية (انعزالية)": ["برود اجتماعي","قلة متعة","انعزال","قلة علاقات وثيقة"],
    "شخصية فُصامية": ["أفكار غريبة","اعتقادات سحرية","ريبة اجتماعية","إدراك غير اعتيادي"],
}
